...
Source: "..\assets\OpenGameMate.AppIcon.ico"; DestDir: "{app}"; DestName: "{#MyAppIconName}"; Flags: ignoreversion

[Icons]
Name: "{group}\OpenGameMate"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\{#MyAppIconName}"
Name: "{autodesktop}\OpenGameMate"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\{#MyAppIconName}"; Tasks: desktopicon
...
english.GameAccountRiskRequired=You must explicitly accept the game account risk notice for this installation. Silent installation cannot skip this confirmation.
...
chinesesimplified.GameAccountRiskRequired=每次安装都必须明确确认游戏账号风险；静默安装不能跳过此确认。
